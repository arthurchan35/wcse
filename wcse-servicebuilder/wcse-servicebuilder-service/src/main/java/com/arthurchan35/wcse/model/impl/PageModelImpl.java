...
/**
 * The base model implementation for the Page service. Represents a row in the &quot;UrlStorage_Page&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class PageModelImpl extends BaseModelImpl<Page> implements PageModel {
	 ...
	 */
	public static final String TABLE_NAME = "UrlStorage_Page";
	...
	public static final String TABLE_SQL_CREATE = "create table UrlStorage_Page (url_id LONG not null primary key,url VARCHAR(75) null,description VARCHAR(75) null,image VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table UrlStorage_Page";
	public static final String ORDER_BY_JPQL = " ORDER BY page.url_id ASC";
	public static final String ORDER_BY_SQL = " ORDER BY UrlStorage_Page.url_id ASC";
	...
	public Object clone() {
		...
		pageImpl.setUrl_id((Word)getUrl_id().clone());
	...
	public CacheModel<Page> toCacheModel() {
		...
		pageCacheModel.url_id = getUrl_id();
