...
/**
 * The persistence utility for the words service. This utility wraps {@link com.arthurchan35.wcse.service.persistence.impl.WordsPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class WordsUtil {
	 ...
	 */
	public static void clearCache(Words words) {
		getPersistence().clearCache(words);
	}
	 ...
	 */
	public static List<Words> findWithDynamicQuery(DynamicQuery dynamicQuery) {
	 ...
	 */
	public static List<Words> findWithDynamicQuery(DynamicQuery dynamicQuery,
		int start, int end, OrderByComparator<Words> orderByComparator) {
	 ...
	 */
	public static Words update(Words words) {
		return getPersistence().update(words);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static Words update(Words words, ServiceContext serviceContext) {
		return getPersistence().update(words, serviceContext);
	}
	...
	*/
	public static void cacheResult(Words words) {
	...
	*/
	public static void cacheResult(List<Words> wordses) {
		getPersistence().cacheResult(wordses);
	}
	...
	*/
	public static Words create(long word_id) {
	...
	*/
	public static Words remove(long word_id)
		throws com.arthurchan35.wcse.exception.NoSuchWordsException {
		return getPersistence().remove(word_id);
	}

	public static Words updateImpl(Words words) {
		return getPersistence().updateImpl(words);
	}
	...
	* @throws NoSuchWordsException if a words with the primary key could not be found
	*/
	public static Words findByPrimaryKey(long word_id)
		throws com.arthurchan35.wcse.exception.NoSuchWordsException {
	...
	*/
	public static Words fetchByPrimaryKey(long word_id) {
		return getPersistence().fetchByPrimaryKey(word_id);
	}

	public static java.util.Map<java.io.Serializable, Words> fetchByPrimaryKeys(
	...
	* @return the wordses
	*/
	public static List<Words> findAll() {
	...
	*/
	public static List<Words> findAll(int start, int end) {
	...
	*/
	...
	public static WordsPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<WordsPersistence, WordsPersistence> _serviceTracker =
		ServiceTrackerFactory.open(WordsPersistence.class);
}