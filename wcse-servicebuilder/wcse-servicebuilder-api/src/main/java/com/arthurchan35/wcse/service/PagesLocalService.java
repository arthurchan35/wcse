...
/**
 * Provides the local service interface for Pages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Arthur Chan
 * @see PagesLocalServiceUtil
...
public interface PagesLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PagesLocalServiceUtil} to access the pages local service. Add custom service methods to {@link com.arthurchan35.wcse.service.impl.PagesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
