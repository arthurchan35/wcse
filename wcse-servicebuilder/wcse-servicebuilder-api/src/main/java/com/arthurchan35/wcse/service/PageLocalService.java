...
public interface PageLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PageLocalServiceUtil} to access the page local service. Add custom service methods to {@link com.arthurchan35.wcse.service.impl.PageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<Page> findPagesByUrlIds(java.lang.String urls, int start,
		int end);
