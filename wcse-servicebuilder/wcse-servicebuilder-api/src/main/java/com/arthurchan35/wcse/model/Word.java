 ...
 * @generated
 */
@ImplementationClassName("com.arthurchan35.wcse.model.impl.WordImpl")
@ProviderType
public interface Word extends WordModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.arthurchan35.wcse.model.impl.WordImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public static final Accessor<Word, Long> WORD_ID_ACCESSOR = new Accessor<Word, Long>() {
			...
			@Override
			public Class<Word> getTypeClass() {
				return Word.class;
			}
		};
}