...
/**
 * The persistence utility for the pages service. This utility wraps {@link com.arthurchan35.wcse.service.persistence.impl.PagesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class PagesUtil {
	 ...
	 */
	public static void clearCache(Pages pages) {
		getPersistence().clearCache(pages);
	}
	 ...
	 */
	public static List<Pages> findWithDynamicQuery(DynamicQuery dynamicQuery) {
	 ...
	 */
	public static List<Pages> findWithDynamicQuery(DynamicQuery dynamicQuery,
		int start, int end, OrderByComparator<Pages> orderByComparator) {
	 ...
	 */
	public static Pages update(Pages pages) {
		return getPersistence().update(pages);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static Pages update(Pages pages, ServiceContext serviceContext) {
		return getPersistence().update(pages, serviceContext);
	}
	...
	*/
	public static void cacheResult(Pages pages) {
	...
	*/
	public static void cacheResult(List<Pages> pageses) {
		getPersistence().cacheResult(pageses);
	}
	...
	*/
	public static Pages create(long url_id) {
	...
	*/
	public static Pages remove(long url_id)
		throws com.arthurchan35.wcse.exception.NoSuchPagesException {
		return getPersistence().remove(url_id);
	}

	public static Pages updateImpl(Pages pages) {
		return getPersistence().updateImpl(pages);
	}
	...
	* @throws NoSuchPagesException if a pages with the primary key could not be found
	*/
	public static Pages findByPrimaryKey(long url_id)
		throws com.arthurchan35.wcse.exception.NoSuchPagesException {
	...
	*/
	public static Pages fetchByPrimaryKey(long url_id) {
		return getPersistence().fetchByPrimaryKey(url_id);
	}

	public static java.util.Map<java.io.Serializable, Pages> fetchByPrimaryKeys(
	...
	* @return the pageses
	*/
	public static List<Pages> findAll() {
	...
	*/
	public static List<Pages> findAll(int start, int end) {
	...
	*/
	...
	public static PagesPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<PagesPersistence, PagesPersistence> _serviceTracker =
		ServiceTrackerFactory.open(PagesPersistence.class);
}